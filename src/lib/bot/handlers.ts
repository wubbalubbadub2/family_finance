...
export const HELP_TEXT =
  `🤖 Что я умею (пиши на естественном языке):\n\n` +
  `💸 Трата:  «кофе 500», «такси 2300»\n` +
  `💰 Доход:  «зарплата 280 000», «доход 50 000 репетиторство»\n` +
  `🤝 Долг:  «должен Алмас 5000», «я должна 10 000 Айгуль»\n\n` +
  `📊 Спросить:  «сколько на кофе?», «итоги месяца», «мои категории»\n\n` +
  `🏷️ Категории:  «создай Развлечения», «переименуй X на Y», «удали X»\n` +
